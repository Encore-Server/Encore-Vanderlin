...
#define NECROPOLIS_CLUTTER_GENERIC list(/obj/structure/flora/grass = 30, /obj/item/natural/stone = 15, /obj/item/natural/rock = 12, /obj/structure/closet/dirthole/closed=0.1, /obj/structure/flora/rock/jungle = 1)
