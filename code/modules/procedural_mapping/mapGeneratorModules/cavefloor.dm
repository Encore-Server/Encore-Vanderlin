...
/datum/mapGeneratorModule/cave
	...
	spawnableAtoms = list(/obj/item/natural/stone = 5, /obj/structure/roguerock=5, /obj/item/natural/rock=3, /obj/structure/kneestingers=1, /obj/structure/innouous_rock = 1)
...
/datum/mapGeneratorModule/cavedirt
	...
	spawnableAtoms = list(/obj/structure/flora/shroom_tree=16, /obj/structure/roguerock=8, /obj/structure/closet/dirthole/closed/loot=3, /obj/item/natural/stone=10, /obj/item/natural/rock=8, /obj/structure/kneestingers = 0)
	allowed_areas = list(/area/under/cave/spider,/area/indoors/cave,/area/under/cavewet,/area/under/cave,/area/under/cavelava)
