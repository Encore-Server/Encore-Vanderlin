/datum/attribute_holder/sheet/job/forlorn
...
/datum/attribute_holder/sheet/job/forlorn/zwei
...
/datum/attribute_holder/sheet/job/forlorn/halberd
	attribute_variance = list(
		/datum/attribute/skill/combat/axesmaces = list(20, 30)
	)
	raw_attribute_list = list(
...
/datum/attribute_holder/sheet/job/forlorn/musket
	raw_attribute_list = list(
		/datum/attribute/skill/combat/firearms = 30,
		/datum/attribute/skill/combat/polearms = 30,
	)

/datum/job/advclass/mercenary/forlorn
	title = "Forlorn Hope Mercenary"
	tutorial = "The Order of the Forlorn Hope, a mercenary company formed a decade ago following a slave revolt in the Qadirid Sultanate. Though the "
	allowed_races = RACES_PLAYER_ALL
	outfit = /datum/outfit/mercenary/forlorn

	attribute_sheet = /datum/attribute_holder/sheet/job/forlorn
...
/datum/outfit/mercenary/forlorn
