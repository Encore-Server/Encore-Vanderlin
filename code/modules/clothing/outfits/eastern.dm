...
/obj/item/clothing/neck/psycross/shell
	...
	desc = "A necklace of strung-up sea shells, the calming noise they make when they clack together is reminiscent of a shellfish's claws. They remind you that while men no longer live in water, Mjallidhorn will always remember our origins."
	sellprice = 25

/obj/item/clothing/neck/psycross/shell/bracelet
	name = "shell bracelet"
	icon_state = "oyster_bracelet"
	desc = "A beaded bracelet made from sea shells, their rough exterior and glossy interior reminding you that Mjallidhorn's children hide the best gifts at the deepest spots beneath the waves."
	sellprice = 15
