...
/obj/item/clothing/head/wizhat/witch
	name = "witch hat"
	desc = "While offically, Witches heretical to Visires and risk harrassment by the faithkeepers, quite a few mages and pestrans wear such hats anyways as a fashion statement."
	icon_state = "witchhat"
	detail_tag = "_detail"
