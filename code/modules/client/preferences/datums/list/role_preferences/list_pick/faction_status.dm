/datum/preference/list_type/role_setting/picker/faction_standing
	...
	string = TRUE
	picker_options = list(
		"Loved by the Burning Banner (Hated by Others)",
		"Loved by Coastal (Hated by Others)",
		"Loved by Mountain Clans (Hated by Others)",
		"Liked by the Burning Banner (Disliked by Others)",
	...
	var/static/list/faction_standing_map = list(
		"Loved by the Burning Banner (Hated by Others)" = list(/datum/world_faction/qadirid_traders, "loved"),
		...
		"Liked by the Burning Banner (Disliked by Others)" = list(/datum/world_faction/qadirid_traders, "liked"),
