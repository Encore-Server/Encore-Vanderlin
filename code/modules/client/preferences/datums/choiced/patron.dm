...
/datum/preference/choiced/patron/create_default_value(datum/preferences/prefs)
	return /datum/patron/divine/gani
...
/datum/preference/choiced/patron/handle_link(datum/preferences/prefs, mob/user)
	...
	for(var/datum/patron/patron as anything in GLOB.patrons_by_faith[pref_patron.associated_faith || /datum/patron/divine/gani::associated_faith])
	...
	if(length(patrons_named))
		var/datum/faith/current_faith = GLOB.faith_list[pref_patron.associated_faith] || GLOB.faith_list[/datum/patron/divine/gani::associated_faith]
