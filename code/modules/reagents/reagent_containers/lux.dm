...
/obj/item/reagent_containers/lux/pragmas
	name = "luxus pragmas"
	desc = "The Divine Essence that Pomette gifted to Archdevils and told him to make a female companion with.\
			He was supposed to make a beautiful and courageous wife from it, is what Pomette had hoped he would do.\
			Instead, Archdevils created the Broodmother who would in turn spawn his armies. Pomette was heartbroken and furious.\
