...
/datum/round_event/graggar_organs/start()
	...
	bordered_message(chosen_one, list(
		...
		span_biginfo("Archdevils hungers! [new_objective.explanation_text]"),
	))
	chosen_one.playsound_local(chosen_one, 'sound/misc/gods/graggar_omen.ogg', 100)

	to_chat(chosen_one, span_notice("Archdevils grants you a power to extract hearts from the dead!"))
