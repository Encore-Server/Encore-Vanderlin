...
/datum/round_event/scholarship_request/start()
	...
	to_chat(chosen_one, span_notice("Akan wishes for you to pass your knowledge! Seek a suitable child or donwtrodden and make them your new apprentice! (RMB on a target with an empty hand)"))
