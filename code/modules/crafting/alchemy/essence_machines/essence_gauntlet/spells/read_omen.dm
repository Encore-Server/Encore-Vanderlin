...
/datum/action/cooldown/spell/essence/read_omen/cast(mob/living/cast_on)
	...
	if(istype(current_storyteller, /datum/storyteller/visires))
		if(istype(user.patron, /datum/patron/divine/visires))
	...
	if(istype(current_storyteller, /datum/storyteller/akan))
		if(istype(user.patron, /datum/patron/divine/akan))
	...
	if(istype(current_storyteller, /datum/storyteller/mjallidhorn))
		if(istype(user.patron, /datum/patron/divine/mjallidhorn))
	...
	if(istype(current_storyteller, /datum/storyteller/gani))
		if(istype(user.patron, /datum/patron/divine/gani))
	...
	if(istype(current_storyteller, /datum/storyteller/mordsol))
		if(istype(user.patron, /datum/patron/divine/mordsol))
	...
	if(istype(current_storyteller, /datum/storyteller/pomette))
		if(istype(user.patron, /datum/patron/divine/pomette))
	...
	if(istype(current_storyteller, /datum/storyteller/valdala))
		if(istype(user.patron, /datum/patron/divine/valdala))
	...
	if(istype(current_storyteller, /datum/storyteller/erdl))
		if(istype(user.patron, /datum/patron/divine/erdl))
	...
	if(istype(current_storyteller, /datum/storyteller/golerkanh))
		if(istype(user.patron, /datum/patron/divine/golerkanh))
	...
	if(istype(current_storyteller, /datum/storyteller/envy))
	...
	if(istype(current_storyteller, /datum/storyteller/deceivers))
		if(istype(user.patron, /datum/patron/inhumen/deceivers))
	...
	if(istype(current_storyteller, /datum/storyteller/hertannea))
		if(istype(user.patron, /datum/patron/inhumen/hertannea))
	...
	if(istype(current_storyteller, /datum/storyteller/archdevils))
	...
	if(istype(current_storyteller, /datum/storyteller/iliope))
		if(istype(user.patron, /datum/patron/divine/iliope))
