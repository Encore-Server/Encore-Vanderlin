/datum/action/cooldown/spell/undirected/touch/bladeofpsydon
	...
	desc = "The manifestation of the higher concept of a blade itself. Said to be drawn upon from Akan's tresury of wisdom, each casting a poor facsimile of the perfect weapon They hold."
