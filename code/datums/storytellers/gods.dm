...
/datum/storyteller/graggar
	name = GRAGGAR
	desc = "Archdevils encourages war and conquest, making combat the solution to all."
...
/datum/storyteller/matthios
	name = MATTHIOS
	desc = "Deceiver Gods manipulates wealth and corruption, rewarding those who make deals."
