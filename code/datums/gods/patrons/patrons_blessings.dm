...
/// Returns the immersive flavor text based on both the target's patron and the specific blessing applied
/// Fully extended for Mjallidhorn, Visires, Hertannea, Gani, Pomette, Archdevils, Goler Kanh, Deceiver Gods, Valdala, Akan, Erdl, Al Aqshir, Iliope, One Envy
/proc/get_patron_blessing_text(mob/living/carbon/human/M, blessing_path)
	...
	var/static/list/blessing_flavor = list(
		...
		/// Archdevils - The Warborn Beast
		/datum/patron/inhumen/graggar = list(
			/datum/status_effect/buff/beastsense = "Archdevils growls: \"Sniff it. Smell the fear, thu fool.\"",
			/datum/status_effect/buff/trollshape = "Archdevils roars: \"Meat swells. Thu strong. Thu crush now.\"",
			/datum/status_effect/buff/divine_beauty = "Archdevils spits: \"Pah! Pretty? WASTE! Git bloody, thu fole!\"",
			/datum/status_effect/buff/call_to_arms = "Archdevils bellows: \"Raise swerd. Kill 'em fast. Or die, weakling!\"",
			/datum/status_effect/buff/craft_buff = "Archdevils smirks: \"Build? HA! Smash it till 'tis strong!\"",
			/datum/status_effect/buff/foodbuff = "Archdevils snorts: \"Meat good. Git strong.\"",
			/datum/status_effect/buff/clean_plus = "Archdevils spits: \"Clean? Bah. Mud good fer ya.\"",
			/datum/status_effect/buff/featherfall = "Archdevils snorts: \"Pah! Drop faster next time.\"",
			/datum/status_effect/buff/darkvision = "Archdevils huffs: \"See 'em hidin'. Then kill 'em.\"",
			/datum/status_effect/buff/haste = "Archdevils yells: \"Fast now! Get killin'!\"",
			/datum/status_effect/buff/calm = "Archdevils grumbles: \"Pff. Calm’s fer weaklings.\"",
			/datum/status_effect/buff/barbrage = "Archdevils roars: \"RAAAGH! Smash 'em flat!\""
		),
		...
		/// Deceiver Gods - The Bandit God
		/datum/patron/inhumen/matthios = list(
			/datum/status_effect/buff/beastsense = "Deceiver Gods laughs: \"Sniff it out, lad. Something worth stealing.\"",
			/datum/status_effect/buff/trollshape = "Deceiver Gods grins: \"Ugly sells well in some towns, friend.\"",
			/datum/status_effect/buff/divine_beauty = "Deceiver Gods smirks: \"Pretty coin, pretty face... both stolen easy.\"",
			/datum/status_effect/buff/call_to_arms = "Deceiver Gods shouts: \"Fight dirty. Win rich.\"",
			/datum/status_effect/buff/craft_buff = "Deceiver Gods shrugs: \"Build fast. Sell faster.\"",
			/datum/status_effect/buff/foodbuff = "Deceiver Gods grins: \"Eat now... pay later.\"",
			/datum/status_effect/buff/clean_plus = "Deceiver Gods cackles: \"Cleaned up nice... for a mark.\"",
			/datum/status_effect/buff/featherfall = "Deceiver Gods chuckles: \"Fall soft... means you live to steal again.\"",
			/datum/status_effect/buff/darkvision = "Deceiver Gods winks: \"See the dark? Hide better.\"",
			/datum/status_effect/buff/haste = "Deceiver Gods shouts: \"Quick hands win riches.\"",
			/datum/status_effect/buff/calm = "Deceiver Gods smirks: \"Calm? Nah, means they don’t see you comin'.\"",
			/datum/status_effect/buff/barbrage = "Deceiver Gods yells: \"Break stuff. Blame someone else!\""
		),
