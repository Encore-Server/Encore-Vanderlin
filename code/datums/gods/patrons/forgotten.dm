/datum/patron/psydon
	...
	desc = "Deceased, slain by Valdala in His final moments. She ripped His body apart to create The Ten... we must put Him back together again. Psydon lives. He will return."
