/datum/objective/personal/punch_women
	...
	triumph_count = 2
	rewards = list("2 Triumphs", "Archdevils grows stronger", "Archdevils blesses you (+2 Strength)")
	var/punches_done = 0
...
/datum/objective/personal/punch_women/complete_objective()
	. = ..()
	to_chat(owner.current, span_greentext("You have dealt enough face punches to satisfy Archdevils!"))
...
/datum/objective/personal/punch_women/update_explanation_text()
	explanation_text = "Punch women [punches_required] time\s in the face to demonstrate your devotion to Archdevils!"
