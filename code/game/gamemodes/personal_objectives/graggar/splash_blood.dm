...
/datum/objective/personal/blood_splash/complete_objective()
	. = ..()
	to_chat(owner.current, span_greentext("You have performed the blood ritual, appeasing Archdevils!"))
...
/datum/objective/personal/blood_splash/update_explanation_text()
	explanation_text = "There is much power in blood. Splash a bucket full of blood on yourself to appease Archdevils!"
