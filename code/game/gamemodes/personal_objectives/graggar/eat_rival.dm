/datum/objective/personal/eat_rival_heart
	...
	category = "Archdevils's Contestant"
	triumph_count = 4
	...
	rewards = list("4 Triumphs", "Archdevils grows stronger", "Overwhelming Power (+3 to all stats)", "Pride of Victory (-2 Stress)")
	var/rival_name
	var/rival_job
...
/datum/objective/personal/eat_rival_heart/complete_objective(escalatation_type = ESCALATION_INTERVENTION_ONLY)
	. = ..()
	to_chat(owner.current, span_greentext("You have proven your strength to Archdevils by consuming your rival's heart! Your rival's power is now YOURS!"))
...
/datum/objective/personal/eat_rival_heart/update_explanation_text()
	explanation_text = "Prove that you are not weak to Archdevils by eating the heart of [rival_name], the [rival_job]! Eat them before they eat YOU!"
