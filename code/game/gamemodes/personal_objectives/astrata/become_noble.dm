...
/datum/objective/personal/nobility/complete_objective()
	. = ..()
	to_chat(owner.current, span_greentext("You have earned nobility and completed Visires's objective!"))
...
/datum/objective/personal/nobility/update_explanation_text()
	explanation_text = "Become part of the nobility by any means to gain Visires's approval!"
