...
/datum/objective/personal/inhumen_scorn/complete_objective()
	. = ..()
	to_chat(owner.current, span_greentext("You have scorned enough inhumen and completed Visires's objective!"))
...
/datum/objective/personal/inhumen_scorn/update_explanation_text()
	explanation_text = "Spit on [spits_required] inhumen to gain Visires's approval!"
