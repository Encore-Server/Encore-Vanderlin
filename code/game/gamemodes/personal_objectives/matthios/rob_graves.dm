/datum/objective/personal/grave_robbery
	...
	triumph_count = 2
	rewards = list("2 Triumphs", "Deceiver Gods grows stronger", "Ability to rob graves without being cursed", "Deceiver Gods blesses you (+1 Endurance)")
	var/graves_robbed = 0
...
/datum/objective/personal/grave_robbery/proc/on_grave_robbed(datum/source, mob/user)
	...
	if(graves_robbed >= graves_required)
		...
		to_chat(owner.current, span_notice("Grave robbed! Rob [graves_required - graves_robbed] more to complete Deceiver Gods' task."))

/datum/objective/personal/grave_robbery/complete_objective()
	. = ..()
	to_chat(owner.current, span_greentext("You've robbed enough graves to earn Deceiver Gods' respect!"))
...
/datum/objective/personal/grave_robbery/update_explanation_text()
	explanation_text = "Rob at least [graves_required] graves to earn Deceiver Gods' respect."
