/datum/objective/personal/hoard_mammons
	...
	triumph_count = 2
	rewards = list("2 Triumphs", "Deceiver Gods grows stronger", "Ability to see item's value on examine", "Deceiver Gods blesses you (+1 Fortune)")
...
/datum/objective/personal/hoard_mammons/complete_objective()
	. = ..()
	to_chat(owner.current, span_greentext("You have accumulated enough mammons, completing Deceiver Gods' objective!"))
...
/datum/objective/personal/hoard_mammons/update_explanation_text()
	explanation_text = "Accumulate at least [target_mammons] mammons in your possession to demonstrate your greediness to Deceiver Gods."
